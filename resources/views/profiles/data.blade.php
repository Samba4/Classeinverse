...
<main class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <em>@lang('Vous pouvez enregistrer cette page pour conserver vos données en utilisant le menu de votre
                navigateur.')</em>
        </div>
    </div>
    <br>
        ...
        <div class="card-body">
            ...
            <table class="table" style="margin-bottom: 140px">
                ...
                <tr>
                    ...
                    <td>
                        <div class="hover_img">
                            <a href="{{ url('images/' . $lecon->name) }}"
                                target="_blank">{{ url('images/' . $lecon->name) }}<span><img
                                        src="{{ url('thumbs/' . $lecon->name) }}" alt="lecon" height="150" /></span></a>
                        </div>
                    </td>
                </tr>
                @endforeach
