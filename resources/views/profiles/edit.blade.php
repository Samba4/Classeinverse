...
<a href="{{ route('profile.destroy', $user->id) }}" class="btn btn-danger btn-sm pull-right invisible" role="button"
    aria-disabled="true"><i class="fas fa-angry fa-lg"></i> @lang('Supprimer mon compte')</a>
@endslot
...
<form method="POST" action="{{ route('profile.update', $user->id) }}">
    ...
    <a href="{{ route('profile.show', $user->id) }}" class="btn btn-warning invisible" role="button"
        aria-disabled="true"><i class="fas fa-dolly fa-lg"></i> @lang('Exporter mes données personnelles')</a>
